...
class Collide(val mathModel: MathModel? = null) : ContactFilter, ContactListener {
...
//        fixtureB!!.userData
    ...
    override fun beginContact(contact: Contact?) {
        ...
        if(type1== GROUP_PATIENT && type2== GROUP_PATIENT){
            ...
            if (p1.isInfectious() && p2.state==PatientModel.STATE_HEALTHY){
                p2.actor!!.contact()
            }else if(p2.isInfectious() && p1.state==PatientModel.STATE_HEALTHY){
                p1.actor!!.contact()
            }
